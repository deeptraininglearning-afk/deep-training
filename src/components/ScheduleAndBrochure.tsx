        ...
        <div className="fixed inset-0 z-50 bg-slate-900/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-2xl w-full p-6 sm:p-8 space-y-6 shadow-2xl relative border border-slate-200">
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <a
                href="data:text/plain;charset=utf-8,Brosur%20Katalog%20Lengkap%20DEEP%20Training%20%26%20Learning%20Solutions%202026.%20Silakan%20hubungi%20info%40deeptraining.id%20atau%20WhatsApp%20081380050039%20untuk%20versi%20cetak%20resmi."
